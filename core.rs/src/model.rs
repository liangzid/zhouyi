...
fn main() {
    ...
    let zhouyimodel=record_64_Gua(&subguas,&xangs,
        &map_xang_gua);
       ...
       fn from_json(path:&str)->Vec<GuaText> {
        ...
        let file_str=r#"[
                ...
                },
                {
                    ...
                    "xang": "《象》曰：天地交，泰，后以財（裁）成天地之道，輔相天地之宜，以左右民。",
                    "yaos": [
                        "初九：拔茅茹，以其夤，征吉。",
                ...
                },
                {
                    ...
                    "xang": "《象》曰：雷出地奮，豫。先王以作樂崇德，殷荐之上帝，以配祖考。",
                    "yaos": [
                        "初六：鳴豫，凶。",
                        "六二：介于石，不終日，貞吉。",
                        "六三：盱豫，悔。遲有悔。",
                ...
                {
                    "gua": "復，亨。出入無疾，朋來無咎。反復其道，七日來復，利有攸往。",
                    "duan": "《彖》曰：復，亨。剛反動而以順行，是以「出入無疾，朋來無咎」。「反復其道，七日來復」，天行也。「利有攸往」，剛長也。復其見天地之心乎？",
                    "xang": "《象》曰：雷在地中，復。先王以至日閉關，商旅不行，后不省方。",
                    "yaos": [
                        "初九：不復遠，無只悔，元吉。",
                        "六二：休復，吉。",
                        "六三：頻復，厲，無咎。",
                ...
                },
                {
                    ...
                    "xang": "《象》曰：天在山中，大畜。君子以多識前言往行，以畜其德。",
                    "yaos": [
                        "初九：有厲，利已。",
                        "九二：輿說輻。",
                ...
                {
                    "gua": "井，改邑不改井，無喪無得。往來井井，汔至亦未繘井，羸其瓶，凶。",
                    "duan": "《彖》曰：巽乎水而上水，井。井養而不窮也。「改邑不改井」，乃以剛中也。「汔至亦未繘井」，未有功也。「羸其瓶」，是以凶也。",
                    "xang": "《象》曰：木上有水，井。君子以勞民勸相。",
                    "yaos": [
                        "初六：井泥不食，舊井無禽。",
                        "九二：井谷射鮒，瓮敝漏。",
            ...
            let gua_txt_ls: Vec<GuaText>=serde_json::from_str(file_str).
